...
This thesis presents an attempt to create a ViT (Vision Transformer) based model for multi label classification of chemical elements present in spectra measured with XRF.
\end{abstract}